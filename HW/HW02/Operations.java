...
//        int returnValue = 0;
//        if (which == 0) {
//            returnValue = num & 0xFFFF;
//        } else {
//            returnValue = (num >> 16) & 0xFFFF;
//        }
    ...
    {
//        0x0000000F << which * 4 (1 * 4, 2 * 4, 3 * 4), ~ to final get set
// bits in nibble to 0000, then use "or" to merge the bit string only nibble
// has value
     ...
     *
     *
     * java -jar hw2checker.jar -g Operations.java
     */

    boolean powerOf2(int num)
    {
        return ((num & -num) == num) && ((num << 1) != 0);
    }
}
